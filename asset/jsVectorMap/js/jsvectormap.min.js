    ...
    var O = function() {
      ...
      , X = function() {
        function t(t, e, i) {
            ...
            this.config.legend && (this.legend = new O(u({
                map: this._map,
                series: this
            }, this.config.legend))),
    ...
    var E = {
        ...
        _setupElementEvents: function() {
            ...
            g.delegate(a, "mouseover mouseout", ".jvm-element", (function(t) {
                ...
                t.defaultPrevented || i && s.tooltip.show()) : (e.element.hover(!1),
                i && s.tooltip.hide())
            }
            )),
        ...
        _createRegions: function() {
            var t, e;
            for (t in this._regionLabelsGroup = this._regionLabelsGroup || this.canvas.createGroup("jvm-regions-labels-group"),
            this.mapData.paths)
                e = new j({
                    map: this,
                    code: t,
        ...
        _setScale: function(t, e, i, s, a) {
            var n, r, o, h, l, c, u, p, d, f, m = this, g = 0, y = Math.abs(Math.round(60 * (t - this.scale) / Math.max(t, this.scale)));
        ...
        coordsToPoint: function(t, e) {
            var i, s, a, n = V.maps[this.params.map].projection, r = n.centralMeridian;
            return i = Y[n.type](t, e, r),
      ...
      , V = function() {
        ...
        return e._init = function() {
            ...
            t.selectedMarkers && this._setSelected("markers", t.selectedMarkers),
        ...
        e.removeLine = function(t, e) {
            ...
            var i = p(t, e);
            this.lines.hasOwnProperty(i) && (this.lines[i].element.remove(),
            delete this.lines[i])
        }
        ,
        e.reset = function() {
        ...
        e.extend = function(e, i) {
            if ("function" == typeof this[e])
                throw new Error("The method [" + e + "] already exists internally please use another name.");
            t.prototype[e] = i
        }
        ,
        t
